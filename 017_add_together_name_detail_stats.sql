-- Adds a secure RPC for Together-mode name details.
-- Returns each participant's stats plus a combined room view.
-- Does not modify votes, rankings, names, rooms, or participants.
...
begin
  ...
  with room_participants as (
    select p.id, p.participant_name
